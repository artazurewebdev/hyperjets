...
if pagechoice == "HyperJets":
    ...
    aircrafts = {
        ...
        "Boeing 747, HyperJets Diamond Aircraft": 40000,
    ...
    with st.expander("See Food Options"):
        ...
        st.write("Fries")
        st.write("Loaded Fries: Fries, Salsa, Guacamole, Sour Cream, Mozzarella and Cheddar Cheese")
        st.write("Ceviche")
        ...
        st.write("Water")
        st.write("1% Milk")
        st.write("Bubble Tea: Half Sugar, Less Ice")
